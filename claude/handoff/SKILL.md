---
name: handoff
description: "Create or refresh a durable handoff in Tarlu's shared vault so either agent can resume the work."
---

# Durable handoff

Read `C:\Users\Tarlu\Documents\Brain\10 - Resources\Handoff Template.md` and `Vault Workflow Contract.md` in that same folder. Apply the shared obsidian-vault skill for retrieval and writes.
