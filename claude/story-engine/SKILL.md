---
name: story-engine
description: Write Wattpad-style serialized fiction — addictive chapters, strong hooks, cliffhangers, and emotional character voice. Use when the user wants to write or plan a story, novel, fanfic, romance, or serialized web fiction; outline chapters; develop characters; draft or revise fiction prose; or asks for "Wattpad-style" writing.
---
...
3. **Outline** — beat out the arc, then outline the *next* chapter as a mini-arc: something happens → something changes → it ends on a question. See [STRUCTURE.md](STRUCTURE.md).
