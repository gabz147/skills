...
3. **Pick the right verb.** Code repo → `/understand`. Domain-heavy app (commerce, finance, healthcare) → `/understand-domain`. Markdown wiki / docs corpus → `/understand-knowledge`.
