...
> Source: [hardikpandya/stop-slop](https://github.com/hardikpandya/stop-slop) — MIT, by Hardik Pandya (hvpandya.com). Integrated into the `human-writing` skill as a reference.
...
**Changes:** Single sentence. No performative emphasis. (Note: the upstream stop-slop "after" uses an em dash here. We swap it for a comma to honor this skill's no-em-dash rule.)
