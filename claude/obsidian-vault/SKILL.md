---
name: obsidian-vault
description: "Search, recall, continue, audit or update Tarlu's shared Obsidian vault. Use for prior decisions, priorities, project history, related notes, daily checkpoints and handoffs."
---

# Shared Obsidian Vault

Vault: `C:\Users\Tarlu\Documents\Brain`. Read `VAULT-INDEX.md` and `10 - Resources\Vault Workflow Contract.md` in full at startup and after compaction. The contract is the single source for schema, model signatures, coordinated writes and capture receipts; the boot files retain critical rules.
...
```powershell
$vaultRoot = 'C:\Users\Tarlu\Documents\Brain'
...
Keep this file byte-identical at `C:\Users\Tarlu\.claude\skills\obsidian-vault\SKILL.md` and `C:\Users\Tarlu\.codex\skills\obsidian-vault\SKILL.md`. Compare hashes after authorized changes and record the reason in the shared guide and daily note. Codex's agents/openai.yaml is UI metadata, not a Claude mirror.
