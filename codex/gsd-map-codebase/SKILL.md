...
description: "[Ported from Claude personal skill] Analyze codebase with parallel mapper agents to produce .planning/codebase/ documents"
---
...
3. Spawn 4 parallel gsd-codebase-mapper agents:
   - Agent 1: tech focus  to  writes STACK.md, INTEGRATIONS.md
   - Agent 2: arch focus  to  writes ARCHITECTURE.md, STRUCTURE.md
   - Agent 3: quality focus  to  writes CONVENTIONS.md, TESTING.md
   - Agent 4: concerns focus  to  writes CONCERNS.md
