...
> Source: [hardikpandya/stop-slop](https://github.com/hardikpandya/stop-slop) — MIT, by Hardik Pandya (hvpandya.com). Integrated into the `human-writing` skill as a reference. Edit freely; the upstream copy is canonical.
