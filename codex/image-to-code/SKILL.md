...
- 1 section requested  to  generate 1 image
- 2 sections requested  to  generate 2 images
- 3 sections requested  to  generate 3 images
- 4 sections requested  to  generate 4 images
- 5 sections requested  to  generate 5 images
- 6 sections requested  to  generate 6 images
- 7 sections requested  to  generate 7 images
- 8 sections requested  to  generate 8 images
- 9 sections requested  to  generate 9 images
- 10 sections requested  to  generate 10 images
...
- a hero only  to  generate 1 hero image
- 4 sections  to  generate 4 section images
- 8 sections  to  generate 8 section images
- 12 sections  to  generate 12 section images when reasonable
