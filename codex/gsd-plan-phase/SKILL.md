---
name: gsd-plan-phase
description: "[Ported from Claude personal skill] Create detailed phase plan (PLAN.md) with verification loop"
---
...
**Default flow:** Research (if needed)  to  Plan  to  Verify  to  Done
...
- `--mvp` - Vertical MVP mode. Planner organizes tasks as feature slices (UI to API to DB) instead of horizontal layers. On Phase 1 of a new project, also emits `SKELETON.md` (Walking Skeleton). Can be persisted on a phase via `**Mode:** mvp` in ROADMAP.md.
