---
name: claude-plugin-ui-ux-pro-max-skill-design-system
description: "[Ported from Claude plugin marketplace skill] Token architecture, component specifications, and slide generation. Three-layer tokens (primitive to semantic to component), CSS variables, spacing/typography scales, component specs, strategic slide creation. Use for design tokens, systematic design, brand-compliant presentations."
---
...
**With ui-styling:** Component tokens  to  Tailwind config
...
| `data/slide-layout-logic.csv` | Goal  to  Layout + break_pattern flag |
| `data/slide-typography.csv` | Content type  to  Typography scale |
| `data/slide-color-logic.csv` | Emotion  to  Color treatment |
| `data/slide-backgrounds.csv` | Slide type  to  Image category (Pexels/Unsplash) |
...
1. Parse goal/context
        ?
2. Search slide-strategies.csv  to  Get strategy + emotion beats
        ?
3. For each slide:
   a. Query slide-layout-logic.csv  to  layout + break_pattern
   b. Query slide-typography.csv  to  type scale
   c. Query slide-color-logic.csv  to  color treatment
   d. Query slide-backgrounds.csv  to  image if needed
