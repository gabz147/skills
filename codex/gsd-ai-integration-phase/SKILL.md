...
description: "[Ported from Claude personal skill] Generate an AI-SPEC.md design contract for phases that involve building AI systems."
---
...
Orchestrates gsd-framework-selector  to  gsd-ai-researcher  to  gsd-domain-researcher  to  gsd-eval-planner.
Flow: Select Framework  to  Research Docs  to  Research Domain  to  Design Eval Strategy  to  Done
</objective>
...
<process>
Execute @$HOME/.claude/get-shit-done/workflows/ai-integration-phase.md end-to-end.
