...
description: "[Ported from Claude personal skill] Grounds every implementation decision in official documentation. Use when you want authoritative, source-cited code free from outdated patterns. Use when building with any framework or library where correctness matters."
---
...
```
DETECT ?? to  FETCH ?? to  IMPLEMENT ?? to  CITE
  ?          ?           ?            ?
  ?          ?           ?            ?
...
```
package.json     to  Node/React/Vue/Angular/Svelte
composer.json    to  PHP/Symfony/Laravel
requirements.txt / pyproject.toml  to  Python/Django/Flask
go.mod           to  Go
Cargo.toml       to  Rust
Gemfile          to  Ruby/Rails
```
...
- Vite 6.2.0
- Tailwind CSS 4.0.3
 to  Fetching official docs for the relevant patterns.
```
...
B) Match existing code (useState) - consistent with codebase
 to  Which approach do you prefer?
```
