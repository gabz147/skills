...
- generic palettes
- default purple-blue startup color cliche?s
...
- 1 screen  to  generate 1 screen image
- 2 screens  to  generate 2 screen images
- 3 screens  to  generate 3 screen images
- 5 screens  to  generate 5 screen images
- 7 screens  to  generate 7 screen images
- onboarding flow  to  generate multiple onboarding screens, not one
- auth flow  to  generate separate sign in / sign up / recovery states when useful
- app concept  to  generate a meaningful set, not one isolated hero mockup
...
Examples:
- onboarding  to  auth  to  home
- home  to  browse  to  detail
- profile  to  settings  to  edit profile
- cart  to  checkout  to  confirmation
- dashboard  to  activity  to  detail
- welcome  to  permissions  to  personalized home
