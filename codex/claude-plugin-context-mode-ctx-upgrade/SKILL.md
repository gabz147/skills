---
name: claude-plugin-context-mode-ctx-upgrade
description: "[Ported from Claude plugin marketplace skill] | Update context-mode from GitHub and fix hooks/settings. Pulls latest, builds, installs, updates npm global, configures hooks. Trigger: /context-mode:ctx-upgrade"
---
