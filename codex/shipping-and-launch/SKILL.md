...
description: "[Ported from Claude personal skill] Prepares production launches. Use when preparing to deploy to production. Use when you need a pre-launch checklist, when setting up monitoring, when planning a staged rollout, or when you need a rollback strategy."
---
...
```
1. DEPLOY with flag OFF      to  Code is in production but inactive
2. ENABLE for team/beta      to  Internal testing in production environment
3. GRADUAL ROLLOUT           to  5%  to  25%  to  50%  to  100% of users
4. MONITOR at each stage     to  Watch error rates, performance, user feedback
5. CLEAN UP                  to  Remove flag and dead code path after full rollout
```
