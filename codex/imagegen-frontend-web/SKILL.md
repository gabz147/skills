...
Across the slice, deliberately vary foreground/background intensity at least twice (lighter  to  richer  to  calmer) so the scroll feels paced, not monotonous slabs.
...
14. remove AI slop (including marquee / fake KPI cliche?s unless requested)
