...
description: "[Ported from Claude personal skill] Gather phase context through adaptive questioning before planning."
---
...
Read and execute `$HOME/.claude/get-shit-done/workflows/discuss-phase-assumptions.md` end-to-end.

If `DISCUSS_MODE` is `"discuss"` (or unset, or any other value):
Read and execute `$HOME/.claude/get-shit-done/workflows/discuss-phase.md` end-to-end.
