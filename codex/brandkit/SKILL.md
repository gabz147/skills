...
Examples:
- build  to  frame, scaffold, block, cursor
- protect  to  shield, boundary, watch mark
- convert  to  switch, arrow, transformation shape
- speak  to  waveform, mic, pulse
- hunt threats  to  eye, raptor, radar, trace
- automate  to  loop, handoff, path
