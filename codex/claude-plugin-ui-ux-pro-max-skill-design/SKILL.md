---
name: claude-plugin-ui-ux-pro-max-skill-design
description: "[Ported from Claude plugin marketplace skill] Comprehensive design skill: brand identity, design tokens, UI styling, logo generation (55 styles, Gemini AI), corporate identity program (50 deliverables, CIP mockups), HTML presentations (Chart.js), banner design (22 styles, social/ads/web/print), icon design (15 styles, SVG, Gemini 3.1 Pro), social photos (HTML to screenshot, multi-platform). Actions: design logo, create CIP, generate mockups, build slides, design banner, generate icon, create social photos, social media images, brand identity, design system. Platforms: Facebook, Twitter, LinkedIn, YouTube, Instagram, Pinterest, TikTok, Threads, Google Ads."
---
...
- Max 2 fonts, min 16px body,  greater than or equal to 32px headline
...
Multi-platform social image design: HTML/CSS  to  screenshot export. Uses `ui-ux-pro-max`, `brand`, `design-system`, `chrome-devtools` skills.
...
4. **Design** - `/ckm:brand`  to  `/ckm:design-system`  to  randomly invoke `/ck:ui-ux-pro-max` OR `/ck:frontend-design`; HTML per idea ? size
...
1. **Logo**  to  `scripts/logo/generate.py`  to  Generate logo variants
2. **CIP**  to  `scripts/cip/generate.py --logo ...`  to  Create deliverable mockups
3. **Presentation**  to  Load `references/slides-create.md`  to  Build pitch deck

### New Design System

1. **Brand** (brand skill)  to  Define colors, typography, voice
2. **Tokens** (design-system skill)  to  Create semantic token layers
3. **Implement** (ui-styling skill)  to  Configure Tailwind, shadcn/ui
