---
name: tdd
description: "[Ported from Claude personal skill] Test-driven development with red-green-refactor loop. Use when user wants to build features or fix bugs using TDD, mentions \"red-green-refactor\", wants integration tests, or asks for test-first development."
---
...
**Correct approach**: Vertical slices via tracer bullets. One test  to  one implementation  to  repeat. Each test responds to what you learned from the previous cycle. Because you just wrote the code, you know exactly what behavior matters and how to verify it.
...
```
RED:   Write test for first behavior  to  test fails
GREEN: Write minimal code to pass  to  test passes
```
...
```
RED:   Write next test  to  fails
GREEN: Minimal code to pass  to  passes
```
