---
name: gsd-spike
description: "[Ported from Claude personal skill] Spike an idea through experiential exploration, or propose what to spike next (frontier mode)"
---
...
- If it is `--wrap-up`: strip the flag, execute the spike-wrap-up workflow from @$HOME/.claude/get-shit-done/workflows/spike-wrap-up.md.
- Otherwise: pass all of $ARGUMENTS as the idea to the spike workflow from @$HOME/.claude/get-shit-done/workflows/spike.md end-to-end.
