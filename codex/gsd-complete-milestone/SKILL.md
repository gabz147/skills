...
description: "[Ported from Claude personal skill] Archive completed milestone and prepare for next version"
---
...
0. **Check for audit:**
   ...
   standard `/gsd-discuss-phase`  to  `/gsd-plan-phase`  to  `/gsd-execute-phase`
...
8. **Offer next steps:**
   - `/gsd-new-milestone` - start next milestone (questioning  to  research  to  requirements  to  roadmap)
