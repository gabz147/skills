---
name: humanize
description: "[Ported from Claude personal skill] ) Rewrite or audit text so it reads like a real person wrote it, not an LLM. Use when the user says writing \"sounds like AI / ChatGPT,\" asks to humanize, de-slop, or make a draft sound natural, asks \"does this sound AI?\", or wants a blog post, LinkedIn post, email, essay, or marketing copy to feel authentic. Strips AI tells (delve, tapestry, \"not X but Y\", em-dash overuse, tricolons, robotic rhythm) and restores a human voice. Includes a linter to score text before and after."
---
...
Watch for *secondary convergence* - don't trade one cliche? for another.
...
- [ ] Linter score dropped to the "reads human" band ( less than or equal to 15); re-run to confirm
- [ ] Zero Tier-1 words; Tier-2 words at most once each, only where natural
- [ ] No "Not X, but Y", no tricolons,  less than or equal to 1 em dash per 500 words
...
- [ ]  greater than or equal to 30% of paragraphs don't end on a tidy conclusion
